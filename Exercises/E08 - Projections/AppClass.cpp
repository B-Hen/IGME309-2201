...
void Application::Display(void)
{
	...
	case 3:
		...
		m_pCamera->SetHorizontalPlanes(vector2(-13.0f, 13.0f));
		m_pCamera->SetVerticalPlanes(vector2(-13.0f, 13.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
	...
	case 5:
		...
		m_pCamera->SetPerspective(true);
		m_pCamera->SetPosition(vector3(0.0f, 0.0f, -15.0f));
		m_pCamera->SetNearFar(vector2(9.5f, 15.0f));
		m_pCamera->SetTarget(vector3(0.0f, 0.0f, 0.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
	...
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(true);
		//matrix4 currentMat = m_pCamera->GetViewMatrix() * glm::rotate(IDENTITY_M4, 90.0f, vector3(0.0f, 1.0f, 0.0f));
